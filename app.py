...
# ─────────────────────────────────────────────────────────────────
# PROFESSIONAL CSS — Netflix/Prime Style
# ─────────────────────────────────────────────────────────────────
st.markdown("""
<style>
...
<div class="nav">
  <div class="nav-left">
    <button class="nav-logo" onclick="location.href='#'; location.reload();">CineMatch</button>
    <div style="display: flex; gap: 12px;">
      <button class="nav-link{'  active' if p == 'home' else ''}" onclick="document.querySelector('[data-testid=stMain]').scrollTop = 0;">Browse</button>
      <button class="nav-link{'  active' if p == 'recs' else ''}" onclick="document.querySelector('[data-testid=stMain]').scrollTop = 0;">For You</button>
      <button class="nav-link{'  active' if p == 'watchlist' else ''}" onclick="document.querySelector('[data-testid=stMain]').scrollTop = 0;">
        Watchlist
        {f'<span class="nav-badge">{wlc}</span>' if wlc else ''}
      </button>
    </div>
  </div>
</div>
...
def render_movie_grid(items):
    ...
    for title, genre in items:
        ...
        grid_html += f"""
<div class="movie-card" onclick="window.scrollTo(0, 0);">
  {img}
...
<div class="hero">
  <div class="hero-content">
    ...
    <div class="hero-subtitle">Browse thousands of movies or let our AI engine recommend films tailored to your taste.</div>
  </div>
</div>
""", unsafe_allow_html=True)
...
<div class="cta-banner">
  <div class="cta-title">Not sure what to watch?</div>
  <div class="cta-subtitle">Tell us your favourite genres or describe what you're in the mood for, and let our AI do the thinking.</div>
</div>
""", unsafe_allow_html=True)
        ...
        if recs.empty:
            ...
            with col1:
                ...
                for i, row in recs.iterrows():
                    ...
                    st.markdown(f"""
<div class="rec-item" onclick="window.scrollTo(0, 0);">
